            ...
            <div className="container mt-2">
              <div className="row">
                <div className="col-lg-5 ml-3">
                  <h3>Login</h3>
                  <small>
                    or <b style={{ color: "#002D62" }}>create an account</b>
                  </small>
                </div>
...
function OtpDrawer({ phoneNumber, setState, state }) {
  ...
  const handleVerify = () => {
    ...
    axios
      ...
      .post(`https://ovs-backend.onrender.com/api/v1/users/login`, {
        phonenumber: phoneNumber,
        otp: parseInt(otp),
      })
      .then((res) => {
  ...
  const getOtp = () => {
    axios
      ...
      .post(`https://ovs-backend.onrender.com/api/v1/users/loginVerify`, {
        phonenumber: phoneNumber,
      })
      .then((res) => {
